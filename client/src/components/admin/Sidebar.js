...
const isActiveStyle =
"flex items-center px-5 gap-3 text-white transition-all duration-200 ease-in-out capitalize hover:bg-gray-500 py-2 my-1 bg-gray-700 rounded-md";
...
const Sidebar = () => {
  ...
  return (
    <div className="flex-[0.2] bg-gray-200">
      <div className="space-y-8 overflow-y-scroll scrollbar-thin scrollbar-track-white scrollbar-thumb-gray-400 h-[30rem]">
        <div className="">
          <NavLink
            to="/admin/home"
            className={({ isActive }) =>
